...
SECRET_KEY = 'django-insecure-7)p@xia)gfixu6l1n1=+zs%-jwxwpf8p)daf4)v95l12sp-9-k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['26.239.20.217','127.0.0.1','192.168.1.107','192.168.20.205','192.168.1.106']
